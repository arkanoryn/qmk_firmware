...
#define FARKANN_SCREEN_ROTATION         QP_ROTATION_90
#define FARKANN_SCREEN_WIDTH            160
#define FARKANN_SCREEN_HEIGHT           128
#define FARKANN_SCREEN_SPI_DIVISOR      0
#define FARKANN_SCREEN_SPI_MODE         4

#define FARKANN_SCREEN_2_ROTATION       QP_ROTATION_0
